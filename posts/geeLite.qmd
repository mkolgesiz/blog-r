...
Folks from World Bank data group published a R package that helps to run local R analysis via Google Earth Engine. I've already made a demo repository on [Github](https://github.com/mkolgesiz/geelite-demo/). I think it's very neat concept that should be kept speading.
...
Install the packages with dependentices. Make sure to use Conda python environment.
